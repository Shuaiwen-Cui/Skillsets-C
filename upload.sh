...
git add .
git status
git commit -m 'auto update C'
echo '--------commit successfully--------'

git push -f https://github.com/Shuaiwen-Cui/Skillsets-C.git main
# git push -u https://github.com/Shuaiwen-Cui/Skillsets-C.git
# git remote add origin https://github.com/Shuaiwen-Cui/Skillsets-C.git
